...
#        end
    ...
    state_machine "wall_and_buoy" do
        ...
        wall2 = state wall_left_new_def(:timeout => 180, :corners => 1)
...
#    end
    ...
    state_machine "inspect_structure" do
      ...
      explore1 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -15.5 + x_offset, :y => 26+ y_offset, :heading => Math::PI, :timeout => 30)
      explore2 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -15.5 + x_offset, :y => 21+ y_offset, :heading => Math::PI, :timeout => 30)
      explore3 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -15.5 + x_offset, :y => 21+ y_offset, :heading => Math::PI/2, :timeout => 30)
      explore4 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20.5 + x_offset, :y => 21+ y_offset, :heading => Math::PI/2, :timeout => 30)
      explore5 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20.5 + x_offset, :y => 21+ y_offset, :heading => 0, :timeout => 30)
      explore6 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20.5 + x_offset, :y => 26+ y_offset, :heading => 0, :timeout => 30)
      explore7 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20.5 + x_offset, :y => 26+ y_offset, :heading => -Math::PI/2, :timeout => 30)
      explore8 = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -15.5 + x_offset, :y => 26+ y_offset, :heading => -Math::PI/2, :timeout => 30)

      explore1b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -16 + x_offset, :y => 25.5+ y_offset, :heading => Math::PI, :timeout => 30)
      explore2b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -16 + x_offset, :y => 21.5+ y_offset, :heading => Math::PI, :timeout => 30)
      explore3b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -16 + x_offset, :y => 21.5+ y_offset, :heading => Math::PI/2, :timeout => 30)
      explore4b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20 + x_offset, :y => 21.5+ y_offset, :heading => Math::PI/2, :timeout => 30)
      explore5b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20 + x_offset, :y => 21.5+ y_offset, :heading => 0, :timeout => 30)
      explore6b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20 + x_offset, :y => 25.5+ y_offset, :heading => 0, :timeout => 30)
      explore7b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -20 + x_offset, :y => 25.5+ y_offset, :heading => -Math::PI/2, :timeout => 30)
      explore8b = state target_move_new_def(:finish_when_reached => true, :depth => -3.0, :delta_timeout => 3, :x => -16 + x_offset, :y => 25.5+ y_offset, :heading => -Math::PI/2, :timeout => 30)

      explore1c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -17 + x_offset, :y => 24+ y_offset, :heading => Math::PI, :timeout => 30)
      explore2c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -17 + x_offset, :y => 22+ y_offset, :heading => Math::PI, :timeout => 30)
      explore3c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -17 + x_offset, :y => 21+ y_offset, :heading => Math::PI/2, :timeout => 30)
      explore4c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -19 + x_offset, :y => 22+ y_offset, :heading => Math::PI/2, :timeout => 30)
      explore5c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -19 + x_offset, :y => 22+ y_offset, :heading => 0, :timeout => 30)
      explore6c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -19 + x_offset, :y => 24+ y_offset, :heading => 0, :timeout => 30)
      explore7c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -19 + x_offset, :y => 24+ y_offset, :heading => -Math::PI/2, :timeout => 30)
      explore8c = state target_move_new_def(:finish_when_reached => true, :depth => -2.0, :delta_timeout => 3, :x => -17 + x_offset, :y => 24+ y_offset, :heading => -Math::PI/2, :timeout => 30)
